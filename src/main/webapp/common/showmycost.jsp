...
<script type="text/javascript">
    ...
    function loadgrid(){
        $('#grid').datagrid({
            ...
            frozenColumns : [ [
                ...
                {title : "活动名称", width : '100',	field : 'activityname',sortable : true}
            ] ],
            columns : [ [
                {title : '需要费用', width : '150', field : 'cost', sortable : false},
                {title : '是否已经缴纳', width : '200',	field : 'pay', sortable : false},
            ...
            toolbar: [
                ...
                "-", {id: 'download',  text: '下载账单',iconCls: 'icon-download', handler: function () {download()} },
                "-", {id: 'participate',  text: '缴费',iconCls: 'icon-participate', handler: function () {pay()} },
    ...
    function pay() {
        ...
        if(row == null){
            ...
            $.messager.alert("警告", "你已经付过该款了",'info');
        } else
        {
