...
<div id="mainWrap" class="easyui-window" title="用户注册表" style="width:600px;padding:175px 0px 0px 275px;">
    <div style="padding:0px 0px 20px 0px">
        <form id="ff" method="post" action="<%=request.getContextPath()%>/userController/register">
            <table cellpadding="5">
                <tr>
                    <td>用户名:</td>
                ...
                <tr>
                    <td>真实姓名:</td>
                    <td><input class="easyui-textbox" type="text" name="realname" id="realname" data-options="required:true"></input></td>
                </tr>
                <tr>
                    <td>密码:</td>
                ...
                <tr>
                    <td>工作:</td>
                    <td><input class="easyui-textbox" type="text" name="job" id="job" data-options="required:true"></input></td>
                </tr>
                <tr>
