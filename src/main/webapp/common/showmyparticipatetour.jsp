...
<%--                    <h3>自定旅程</h3>--%>
                    <div class="services">
                        <ul>
                            <li><a href="<%=request.getContextPath()%>/common/showmytour.jsp">我组织的旅程</a></li>
                        </ul>
...
<script type="text/javascript">
    ...
    function loadgrid(){
        $('#grid').datagrid({
            title : '客户信息一览表',
            url:'http://localhost:8080/json/showmyparticipatetour.json',
            method: 'post',
            ...
            toolbar: [
                ...
                "-", {id: 'remove', text: '退出',iconCls: 'icon-remove', handler: function () {remove()} },
    ...
    function reload(){
        window.location.href="http://localhost:8080/tourController/viewMyParticipateTour";
